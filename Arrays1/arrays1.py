...
# Display the original array 
    display_array("foods in origional order: ", foods)
# Display the sorted array   
    foods.sort()
    display_array("foods in ascending alphabetical order: ", foods)
# Display the reverse sorted array    
    foods.sort(reverse=True)
    display_array("foods in descending alphabetical order: ", foods)
# Copy the orignal array and sort the copy
    foods2 = foods.copy()
    foods2.sort()
    display_array("foods2 in ascending alphabetical order: ", foods2)
# Show the original array still in reverse order
    display_array("foods still in descending alphabetical order: ", foods)
...
# Append the new items to the sorted array
    ...
    foods.append("milk")
    display_array("sorted foods with carrots and milk appended to end: ", foods)
